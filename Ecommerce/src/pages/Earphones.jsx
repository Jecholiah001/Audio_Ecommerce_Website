    ...
    <div>
      ...
      <div className=' grid grid-cols-2 gap-20 mt-40 mb-16 mx-[150px]'>
        ...
        <div className='font-custom m-24'>
          ...
          <h1 className='text-[40px] font-[700]  leading-[44px] tracking-[1.4px] py-8'>YX1 WIRELESS EARPHONES</h1>
          ...
          <Link to={"/earphone"}><button className=' bg-deepOrange hover:bg-lightOrange text-white text-[13px] leading-[17px] tracking-[1px] py-3 px-7'>SEE PRODUCT</button></Link>
        </div>
      </div>
