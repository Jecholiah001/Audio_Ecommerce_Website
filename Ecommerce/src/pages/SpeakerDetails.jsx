...
function SpeakerDetails({data}) {
    ...
    return (
        ...
        <Header/>
        <Link to='/speakers'><button className='ml-[150px] mt-20 text-[15px] font-[400]  leading-[25px] opacity-[70%]'>Go Back</button></Link>
        ...
        <div>
            ...
            return (
                ...
                <Link to={`/speakers/${product.id}`}><button className=' bg-deepOrange hover:bg-lightOrange text-white text-[13px]  leading-[17px] tracking-[1px] py-3 px-7 my-10 ml-[100px]'>SEE PRODUCT</button>
                </Link>
                </div>
            )
            })}
